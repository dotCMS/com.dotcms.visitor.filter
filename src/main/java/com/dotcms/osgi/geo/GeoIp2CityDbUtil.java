...
public class GeoIp2CityDbUtil {
    private final static String GEO_LIGHT_DB_PATH = "GEO_LIGHT_DB_PATH";
    ...
    private CityResponse cityResponse() {
        try {
            return GeoIp2CityDbUtil.reader.city(inetAddress);
        } catch (IOException | GeoIp2Exception e) {
            throw new DotRuntimeException("unable to find city:" + e);
        }
    }
     ...
     *         established.
     */
    private static DatabaseReader connectToDatabase(InputStream database) {
        try {
    ...
    public String getCityName() throws IOException, GeoIp2Exception {
        ...
        return (city.getCity()!=null) ?  city.getCity().getName() : null;
    }
